...
var chalk = require('chalk'); // color cmd output
var parse = require('react-docgen').parse;
var chokidar = require('chokidar'); // watch files cross plarform
...
// use chockidar if --watch flag passed
...
function getComponentData(paths, componentName) {
  ...
  var info = parse(content); // parse from react doc gen
  return {
    name: componentName,
