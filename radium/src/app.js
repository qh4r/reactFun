...
export default class DriftApp extends React.Component {
    ...
    render() {
        return (
            <StyleRoot>
                <Frame>
                    {/*uzywamy komponentu styli i przkeazujemy do  inego konfiguracje tworzac w ten sposob
                     style globalne dla Frame i dzieci*/}
                    <Style rules={styles}/>
                    <Carousel showIndex={this.state.showIndex} nav={this.renderNav()} width={config.imageWidth}>
                        <Slide image={require('./images/1.jpg')} title="Imperial Mockery">
                            ...
                            Empire.
                            These objects were immediately removed from the reflecting pool in Coruscant's Central
                            Square when found
                            this morning.
                        </Slide>
                        ...
                        <Slide image={require('./images/3.jpg')} title="Master and Apprentice">
                            ...
                            in that line of
                            work. They will likely be able to show you what it's really like before you commit your
                            future.
                        </Slide>
